...
const HomePage = ({ onOpenArticle }) => {
  ...
  const mockNews = [
    {
      ...
      snippet:
        "Major infrastructure projects announced including road connectivity improvements and digital infrastructure expansion across rural areas.",
    ...
    },
    {
      ...
      snippet:
        "Recent economic data indicates steady growth in key sectors with improved employment rates and increased investment.",
      source: "My Republica",
      published_at: Date.now() / 1000,
    ...
    },
    {
      ...
      snippet:
        "New environmental protection initiatives launched with focus on sustainable development and climate change adaptation.",
    ...
    },
    {
      ...
      snippet:
        "Misinformation regarding unproven COVID-19 treatments continues to circulate on social media platforms despite lack of scientific evidence.",
    ...
    },
    {
      ...
      snippet:
        "Local technology companies report significant growth with increased demand for digital services and solutions.",
      source: "Tech Today",
      published_at: Date.now() / 1000,
      verification_status: "VERIFIED_TRUE",
      category: "Technology",
    ...
    },
    {
      ...
      snippet:
        "Debunked conspiracy theories linking 5G networks to health issues continue to spread despite scientific consensus on safety.",
  ...
  const getTabCounts = () => {
    ...
    const verified = news.filter(
      (n) => n.verification_status === "TRUE"
    ).length;
    const debunked = news.filter(
      (n) => n.verification_status === "FALSE"
    ).length;
